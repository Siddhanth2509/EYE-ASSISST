"""
Phase 1C — APTOS Preprocessing (Unified)
...
CSV_PATH = r"Data\raw\Aptos\train.csv"
IMG_DIR  = r"Data\raw\Aptos\images"
DST_ROOT = r"Data\processed\fundus\aptos"
TARGET_SIZE = (224, 224)
...
for _, row in tqdm(df.iterrows(), total=len(df), desc="APTOS preprocessing"):
    img_id = row["id_code"]
    level = int(row["diagnosis"])

    src = os.path.join(IMG_DIR, img_id + ".png")  # APTOS images are .png
...
print("✅ APTOS preprocessing complete (unified).")
